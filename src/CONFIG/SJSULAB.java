...
//    public static String getVmwareVM() { return "paul@nguyenresearch.com" ; }
    ...
    public static String getVmwareHostURL() { return "https://130.65.157.242" ; }
    public static String getVmwareLogin() { return "root" ; }
    public static String getVmwarePassword() { return "12!@qwQW" ; }
    public static String getVmwareVM() { return "Roopak_Vm1" ; }
